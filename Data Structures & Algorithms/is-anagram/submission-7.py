class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        for c in t:
            # if current charcter in dict then get the count else assume 0 and decrease by 1
            map_of_s[c] = map_of_s.get(c, 0) - 1
            #if count of character less than 0 hence word t has more occurance of character c
            if map_of_s[c] < 0:
                return False
